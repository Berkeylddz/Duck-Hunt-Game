...
/**
 The Level1 class represents the first level of a game. It extends the GameLevel class and implements the functionality
 specific to Level 1. It contains methods to start and end the level, handle key presses, and manage game elements such
...
public class Level1 extends GameLevel{
    ...
    /**
     Constructs a Level1 object with the specified parameters.
     ...
     */
    public Level1(Stage primaryStage, StackPane root, Integer backgorundIndex, Integer crossairIndex, double SCALE,double VOLUME) {
    ...
    /**
     Starts Level 1 by initializing game elements, setting up event handlers, and starting animation timelines.
    ...
    public void startLevel(ImageView gamePageImageview, Integer crosshairImageView) {
        ...
        duckImageView.get().setFitHeight(duckImage1.getHeight()*SCALE); //bunlar sclae edilecek
        ...
        double maxX = bounds.getMaxX()-150;
    ...
    /**
     ...
     @return always returns false as Level 1 does not end the game
     */
    @Override
